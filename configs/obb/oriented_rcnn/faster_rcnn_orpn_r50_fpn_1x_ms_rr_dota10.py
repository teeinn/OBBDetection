...
# data_root = '/media/qisens/2tb1/python_projects/training_pr/OBBDetection/tools/data/split_ms_dota1_0/'
data_root = '/media/qisens/2tb1/python_projects/training_pr/OBBDetection/satellite_image/'
img_norm_cfg = dict(
